...
#define SPECIES_LIST "scenario_library/GJ876/N2-CO2-Full-CO/species_scenario_N2r_low.dat"
...
#define IMPORTFILEX "scenario_library/GJ876/N2-CO2-Full-CO/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/GJ876/N2-CO2-Full-CO/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/Conx.dat"
#define OUT_FILE2			"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/Conf.dat"
#define OUT_HISTORY			"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/History.dat"
#define OUT_PHOTORATE		"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/Timescale.dat"
#define OUT_COLUMN			"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/ColumnDensity.dat"
#define OUT_STD				"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/GJ876/N2-CO2-Full-CO/CO_2E12/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/GJ876/N2-CO2-Full-CO/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/GJ876/N2-CO2-Full-CO/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/GJ876/N2-CO2-Full-CO/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/GJ876/N2-CO2-Full-CO/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/GJ876/N2-CO2-Full-CO/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/GJ876/N2-CO2-Full-CO/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/GJ876/N2-CO2-Full-CO/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/GJ876/N2-CO2-Full-CO/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/GJ876/N2-CO2-Full-CO/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/GJ876/N2-CO2-Full-CO/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/GJ876/N2-CO2-Full-CO/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/GJ876/N2-CO2-Full-CO/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/GJ876/N2-CO2-Full-CO/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/GJ876/N2-CO2-Full-CO/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/GJ876/N2-CO2-Full-CO/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/GJ876/N2-CO2-Full-CO/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/GJ876/N2-CO2-Full-CO/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/GJ876/N2-CO2-Full-CO/CloudTopE.dat"      /* Output emission cloud top file name */
