...
#define SPECIES_LIST "scenario_library/Sun/CO2/species_scenario_CO2N2r_emi.dat"
...
#define IMPORTFILEX "scenario_library/Sun/CO2/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/Sun/CO2/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/Sun/CO2/Conx.dat"
#define OUT_FILE2			"scenario_library/Sun/CO2/Conf.dat"
#define OUT_HISTORY			"scenario_library/Sun/CO2/History.dat"
#define OUT_PHOTORATE		"scenario_library/Sun/CO2/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/Sun/CO2/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/Sun/CO2/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/Sun/CO2/Timescale.dat"
#define OUT_COLUMN			"scenario_library/Sun/CO2/ColumnDensity.dat"
#define OUT_STD				"scenario_library/Sun/CO2/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/Sun/CO2/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/Sun/CO2/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/Sun/CO2/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/Sun/CO2/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/Sun/CO2/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/Sun/CO2/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/Sun/CO2/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/Sun/CO2/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/Sun/CO2/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/Sun/CO2/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/Sun/CO2/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/Sun/CO2/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/Sun/CO2/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/Sun/CO2/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/Sun/CO2/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/Sun/CO2/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/Sun/CO2/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/Sun/CO2/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/Sun/CO2/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/Sun/CO2/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/Sun/CO2/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/Sun/CO2/CloudTopE.dat"      /* Output emission cloud top file name */
