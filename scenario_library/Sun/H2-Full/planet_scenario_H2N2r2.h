...
#define TMAX 1.0E+100 /* Maximum of time step */
...
#define SPECIES_LIST "scenario_library/Sun/H2-Full/species_scenario_H2N2r2.dat"
...
#define IMPORTFILEX "scenario_library/Sun/H2-Full/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/Sun/H2-Full/Conf.dat" /* File of concentrations F to be imported */       
...
#define OUT_FILE2			"scenario_library/Sun/H2-Full/Conf.dat"
#define OUT_HISTORY			"scenario_library/Sun/H2-Full/History.dat"
#define OUT_PHOTORATE		"scenario_library/Sun/H2-Full/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/Sun/H2-Full/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/Sun/H2-Full/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/Sun/H2-Full/Timescale.dat"
#define OUT_COLUMN			"scenario_library/Sun/H2-Full/ColumnDensity.dat"
#define OUT_STD				"scenario_library/Sun/H2-Full/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/Sun/H2-Full/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/Sun/H2-Full/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/Sun/H2-Full/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/Sun/H2-Full/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/Sun/H2-Full/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/Sun/H2-Full/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/Sun/H2-Full/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/Sun/H2-Full/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/Sun/H2-Full/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/Sun/H2-Full/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/Sun/H2-Full/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/Sun/H2-Full/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/Sun/H2-Full/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/Sun/H2-Full/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/Sun/H2-Full/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/Sun/H2-Full/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/Sun/H2-Full/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/Sun/H2-Full/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/Sun/H2-Full/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/Sun/H2-Full/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/Sun/H2-Full/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/Sun/H2-Full/CloudTopE.dat"      /* Output emission cloud top file name */
