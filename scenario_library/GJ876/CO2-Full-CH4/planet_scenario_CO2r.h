...
#define FUVMULT				1.0E+0		/* Multiplying factor for FUV radiation <200 nm */
#define MUVMULT				1.0E+0		/* Multiplying factor for MUV radiation 200 - 300 nm */
#define NUVMULT				1.0E+0		/* Multiplying factor for NUV radiation 300 - 400 nm */
...
#define SPECIES_LIST "scenario_library/GJ876/CO2-Full-CH4/species_scenario_N2r_low.dat"
...
#define IMPORTFILEX "scenario_library/GJ876/CO2-Full-CH4/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/GJ876/CO2-Full-CH4/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/Conx.dat"
#define OUT_FILE2			"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/Conf.dat"
#define OUT_HISTORY			"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/History.dat"
#define OUT_PHOTORATE		"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/Timescale.dat"
#define OUT_COLUMN			"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/ColumnDensity.dat"
#define OUT_STD				"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/GJ876/CO2-Full-CH4/CH4_3E11_low_O2_CO/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/GJ876/CO2-Full-CH4/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/GJ876/CO2-Full-CH4/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/GJ876/CO2-Full-CH4/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/GJ876/CO2-Full-CH4/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/GJ876/CO2-Full-CH4/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/GJ876/CO2-Full-CH4/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/GJ876/CO2-Full-CH4/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/GJ876/CO2-Full-CH4/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/GJ876/CO2-Full-CH4/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/GJ876/CO2-Full-CH4/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/GJ876/CO2-Full-CH4/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/GJ876/CO2-Full-CH4/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/GJ876/CO2-Full-CH4/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/GJ876/CO2-Full-CH4/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/GJ876/CO2-Full-CH4/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/GJ876/CO2-Full-CH4/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/GJ876/CO2-Full-CH4/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/GJ876/CO2-Full-CH4/CloudTopE.dat"      /* Output emission cloud top file name */
